...
select *
 from customer.`customer-churn-prediction`;
...
select 
    (select distinct count(*) from customer.`customer-churn-prediction`) as distinct_values,
    (select count(*) from customer.`customer-churn-prediction` where count(*) 
    not in (select distinct count(*) from customer.`customer-churn-prediction`)) as non_distinct_values;
...
alter table customer.`customer-churn-prediction`
